...
const Sustained = ({
  ...
  // let autocompleteDisplay;
  // if (document.querySelector('input').value.length > 0) {
  //   autocompleteDisplay = { display: 'flex' };
  // } else if (document.querySelector('input').value.length <= 0) {
  //   autocompleteDisplay = { display: 'none' };
  // }
  return (
      ...
      <div className="sustained-info">
        ...
        <p className="temp">{weather.temp}°F</p>
          <Controls
            ...
            cityTrie={cityTrie} />
            <AutoComplete
              className='autocomplete-box-sustained'
        ...
        <div id="seven-hour-weather"
          ...
          onKeyPress={(e) => {
            ...
            if (key === 13) {
              ...
              // setViewClass('seven-hour-weather');
            }
          }}
          tabIndex="0">
