...
export default class App extends Component {
  constructor(props) {
    ...
    this.changeCurrentViewToCurrent = this.changeCurrentViewToCurrent(this);
    this.changeCurrentViewToSevenHour = this.changeCurrentViewToSevenHour(this);
    this.changeCurrentViewToTenDay = this.changeCurrentViewToTenDay(this);
